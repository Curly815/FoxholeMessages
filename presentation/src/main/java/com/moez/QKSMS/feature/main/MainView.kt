...
//    val plusBannerIntent: Observable<*>
    ...
    val confirmArchiveIntent: Observable<List<Long>>
    ...
    fun showArchiveDialog(conversations: List<Long>)
...
enum class NavItem { BACK, INBOX, ARCHIVED, TRASH, BACKUP, SCHEDULED, BLOCKING, MESSAGE_UTILS, SETTINGS, ABOUT, PLUS, HELP, INVITE }
